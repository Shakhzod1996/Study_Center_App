          ...
          <TableBody>
            {data.map((row, i) => (
              ...
              >
                ...
                <TableCell>Guruh {row.guruh}</TableCell>
                <TableCell>{row.holati}</TableCell>
                <TableCell>{row.guruhNomi}</TableCell>
                <TableCell>{row.tulovShakli}</TableCell>
                <TableCell>$ {row.tulovMiqdori}.00</TableCell>
                <TableCell>{row.uqituvchi}</TableCell>
